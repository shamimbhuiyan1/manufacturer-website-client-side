    ...
    <div>
      ...
      >
        ...
        {errors.details?.type === "required" && (
          <p className="text-red-400 text-sm ">Please add product details!</p>
        )}
        <input
        ...
        {errors.price?.type === "required" && (
          <p className="text-red-400 text-sm ">Please add product price!</p>
        )}
        ...
        {errors.image?.type === "required" && (
          <p className="text-red-400 text-sm ">Please add product image!</p>
        )}
        <input
          type="submit"
