...
const ManageProducts = () => {
  ...
  const {
    ...
    fetch("https://hexa-tools.herokuapp.com/product").then((res) => res.json())
  );
          ...
          <tbody>
            {products.map((p) => (
              <tr key={p._id}>
                ...
                <td>
                  <div className="flex items-center gap-1">${p.price}</div>
                </td>
                <td>{p.available}</td>
        ...
        <>
          ...
          <div class="modal modal-bottom sm:modal-middle">
            <div class="modal-box">
              ...
              <p>
                Are you sure you want to delete this product? Product will be
                deleted permanently.
              </p>
