                ...
                <tr key={order._id}>
                  ...
                  <td>
                    <div className="flex flex-col">
                      ...
                      <span className="text-slate-400">{order.orderTime}</span>
                    </div>
                  </td>
                  <td>
                    <div className="flex flex-col">
                      <span className="text-slate-500">{order.txId}</span>
                    </div>
                  </td>
                  <th>
        ...
        <>
          ...
          <div class="modal modal-bottom sm:modal-middle">
            <div class="modal-box">
              ...
              <p>
                Are you sure you want to delete this order? Order will be
                deleted permanently.
              </p>
