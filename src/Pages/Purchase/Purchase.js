            ...
            <div className="sticky top-20">
              <div className="flex gap-5">
                ...
                <div className="text-left">
                  ...
                  <h4 className="">
                    Minimum order quantity: {product?.minimum_order} unit.
                  </h4>
                </div>
              </div>
          ...
          <div className="md:w-3/6">
            <div className="border shadow-2xl shadow-slate-200 p-10 rounded-lg">
              ...
              >
                ...
                <p className="text-slate-500">Minimum quantity : 100 unit</p>
                ...
                {errors.quantity?.type === "required" && (
                  <p className="text-red-400 text-sm ">Please add quantity!</p>
                )}
                {quantity < minimumUnit && (
                  <p className="text-red-400 text-sm ">
                    Minimum order unit is <strong>{minimumUnit}</strong>
                  </p>
                )}
